...
export default function SignupPage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen py-2">
            ...
            <label htmlFor="username" className="w-full max-w-xs mb-2">Username</label>
            <input 
            ...
            />
            <button className="p-2 bg-blue-500 text-white rounded-lg w-full max-w-xs mt-4">Signup</button>
